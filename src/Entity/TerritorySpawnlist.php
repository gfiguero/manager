 ...
 * TerritorySpawnlist
 *
 * @ORM\Table(name="l2j_gs.territory_spawnlist", indexes={@ORM\Index(name="id", columns={"castleId"})})
 * @ORM\Entity
 */
class TerritorySpawnlist
{
    /**
     * @var int
     *
     ...
     * @var int
     *
     * @ORM\Column(name="x", type="integer", length=6, nullable=false, options={"default" = 0})
     */
    private $x = '0';
     ...
     * @var int
     *
     * @ORM\Column(name="y", type="integer", length=6, nullable=false, options={"default" = 0})
     */
    private $y = '0';
     ...
     * @var int
     *
     * @ORM\Column(name="z", type="integer", length=6, nullable=false, options={"default" = 0})
     */
    private $z = '0';
