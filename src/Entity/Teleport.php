 ...
 * Teleport
 *
 * @ORM\Table(name="l2j_gs.teleport", indexes={@ORM\Index(name="itemId", columns={"itemId"})})
 * @ORM\Entity
 */
class Teleport
{
     ...
     * @var int
     *
     * @ORM\Column(name="id", type="integer", nullable=false, options={"unsigned"=true, "default"="0"})
     * @ORM\Id
     */
    private $id = '0';
